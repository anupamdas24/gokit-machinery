...
const (
	binaryOutput = "./bookmarkd/bookmarkd"
	packageName  = "github.com/shijuvar/gokit-machinery/src/bookmark-api/bookmarkd"
	goexe        = "go"
)
...
func Docker() error {
	if err := docker("build", "-t", "bookmark", "."); err != nil {
		return err
	}
	return nil
}
...
var pkgPrefixLen = len("github.com/shijuvar/gokit-machinery/src/bookmark-api")

func bookmarkPackages() ([]string, error) {
	mg.Deps(getDep)

...
// Source: github.com/shijuvar/gokit-machinery/src/http/restapi/model (interfaces: Repository)
...
import (
	...
	model "github.com/shijuvar/gokit/examples/http/restapi/model"
)
...
func (m *MockRepository) Create(arg0 model.Note) error {
	m.ctrl.T.Helper()
